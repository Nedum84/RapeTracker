...
import com.ng.rapetracker.adapter.PlacesAutoCompleteAdapter
import com.ng.rapetracker.databinding.FragmentPickAddressBinding
...
class FragmentPickAddress : BottomSheetDialogFragment(), PlacesAutoCompleteAdapter.ClickListener {
    ...
    override fun click(place: Place?) {//Places recycler view click
        ...
        binding.placeSearch.hint = place.address.toString()
    ...
    private suspend fun getAddressFromLatLong() {
