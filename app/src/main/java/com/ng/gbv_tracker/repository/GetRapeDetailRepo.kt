package com.ng.gbv_tracker.repository
...
//                _properties.value = listResult
                ...
                Log.d("44444444444", "${listResult[0].nyscAgentId} ----- $type -- $user_id_org_type")
            } catch (e: Exception) {
                Log.d("44444444444", "${e.printStackTrace()} ----- $type -- $user_id_org_type")
                e.printStackTrace()
