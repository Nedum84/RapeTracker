...
import com.ng.gbv_tracker.room.TableNames.Companion.RAPE_DETAIL_TABLE
...
class RapeDetail (
    ...
    var isCaseResolved:Int = 0
):Parcelable{

    fun monthYr() = ClassDateAndTime().getMonth(dateAdded)+"\n"+ClassDateAndTime().getYr(dateAdded)
    fun time_() = ClassDateAndTime().getTime(dateAdded)
}
